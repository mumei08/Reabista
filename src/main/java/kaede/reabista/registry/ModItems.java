...
public class ModItems {
    ...
    public static final RegistryObject<Item> HEALER_CRYSTAL =
            ITEMS.register("healer_crystal", HealerCrystal::new);
    public static final RegistryObject<Item> LIGHTNING_CRYSTAL =
            ITEMS.register("lightning_crystal", LightningCrystal::new);
    public static final RegistryObject<Item> STRENGTH_CRYSTAL =
            ITEMS.register("strength_crystal", StrengthCrystal::new);
    public static final RegistryObject<Item> CLONE_CRYSTAL =
            ITEMS.register("clone_crystal", CloneCrystal::new);
    public static final RegistryObject<Item> SMOKE_CRYSTAL =
            ITEMS.register("smoke_crystal", SmokeCrystal::new);
    public static final RegistryObject<Item> BINARY_CRYSTAL =
            ITEMS.register("binary_crystal", BinaryCrystal::new);
    public static final RegistryObject<Item> ERASE_CRYSTAL =
            ITEMS.register("erase_crystal", EraseCrystal::new);
    public static final RegistryObject<Item> CREATION_CRYSTAL =
            ITEMS.register("creation_crystal", CreationCrystal::new);
    public static final RegistryObject<Item> DESTRUCTION_CRYSTAL =
            ITEMS.register("destruction_crystal", DestructionCrystal::new);
    public static final RegistryObject<Item> ZERO_FRAGMENT =
            ITEMS.register("zero_fragment", kaede.reabista.item.ZeroFragment::new);
    public static final RegistryObject<Item> ONE_FRAGMENT =
            ITEMS.register("one_fragment", kaede.reabista.item.OneFragment::new);
    public static final RegistryObject<Item> HARDENED_BLOCK_ITEM =
            ITEMS.register("hardened_block", () -> new net.minecraft.world.item.BlockItem(
                    ModBlocks.HARDENED_BLOCK.get(), new Item.Properties()));
}