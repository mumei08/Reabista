...
public class ModItemWom {
    ...
    public static final RegistryObject<Item> GOD_THEUSFALL_1 =
            ITEMS.register("god_theusfall_1", () -> new GodTheusfall_1((new Item.Properties()).rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> GOD_THEUSFALL_2 =
            ITEMS.register("god_theusfall_2", () -> new GodTheusfall_2((new Item.Properties()).rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> GOD_THAOSVENOM_1 =
            ITEMS.register("god_thaosvenom_1", () -> new GodThaosvenom_1((new Item.Properties()).rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> GOD_THAOSVENOM_2 =
            ITEMS.register("god_thaosvenom_2", () -> new GodThaosvenom_2((new Item.Properties()).rarity(Rarity.EPIC)));
}
