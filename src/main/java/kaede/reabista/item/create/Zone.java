...
public class Zone extends Item {
    ...
    public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
        if (!entity.level().isClientSide()) {
            entity.addEffect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 6000, 4, false, false));
            entity.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 6000, 4, false, false));
        }
